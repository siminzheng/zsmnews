...
public class WangyiVideoerciyuan_Bean {


    @SerializedName("VBF8F1PSA")
    private List<VBF8F1PSAEntity> vBF8F1PSA;

    public List<VBF8F1PSAEntity> getVBF8F1PSA() {
        return vBF8F1PSA;
    }

    public void setVBF8F1PSA(List<VBF8F1PSAEntity> vBF8F1PSA) {
        this.vBF8F1PSA = vBF8F1PSA;
    }

    public static class VBF8F1PSAEntity {
        private int sizeHD;
