...
public class WangyiVideozhangzishi_Bean {


    @SerializedName("VBF8F3SGL")
    private List<VBF8F3SGLEntity> vBF8F3SGL;

    public List<VBF8F3SGLEntity> getVBF8F3SGL() {
        return vBF8F3SGL;
    }

    public void setVBF8F3SGL(List<VBF8F3SGLEntity> vBF8F3SGL) {
        this.vBF8F3SGL = vBF8F3SGL;
    }

    public static class VBF8F3SGLEntity {
        private int sizeHD;
