...
public class WangyiVideoheikeji_Bean {


    @SerializedName("VBF8F2PKF")
    private List<VBF8F2PKFEntity> vBF8F2PKF;

    public List<VBF8F2PKFEntity> getVBF8F2PKF() {
        return vBF8F2PKF;
    }

    public void setVBF8F2PKF(List<VBF8F2PKFEntity> vBF8F2PKF) {
        this.vBF8F2PKF = vBF8F2PKF;
    }

    public static class VBF8F2PKFEntity {
        private int sizeHD;
