...
public class WangyiVideoxinwen_Bean {


    @SerializedName("VAV3H6JSN")
    private List<VAV3H6JSNEntity> vAV3H6JSN;

    public List<VAV3H6JSNEntity> getVAV3H6JSN() {
        return vAV3H6JSN;
    }

    public void setVAV3H6JSN(List<VAV3H6JSNEntity> vAV3H6JSN) {
        this.vAV3H6JSN = vAV3H6JSN;
    }

    public static class VAV3H6JSNEntity {
        private int sizeHD;
