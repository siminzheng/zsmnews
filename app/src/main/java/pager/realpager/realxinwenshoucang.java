...
public class realxinwenshoucang extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_realxinwenshoucang);
        ...
        LogUtil.e("这个被收藏的新闻的url和标题是："+realNewsurl+"   "+realNewsTitle);
        ...
        shoucanganniu.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean ischecked) {
                ...
                if (nes2list.size() == 0 &&ischecked){
                    ...
                    nes.save();
                    Toast.makeText(realxinwenshoucang.this,"新闻收藏成功",Toast.LENGTH_SHORT).show();

                }else if (nes2list.size() > 0 && !ischecked){
                    LitePal.deleteAll(newsshoucang.class,"url=?",realNewsurl);
                    Toast.makeText(realxinwenshoucang.this,"新闻取消收藏成功",Toast.LENGTH_SHORT).show();
                }
