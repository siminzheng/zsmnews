...
public class RealPhotoPager extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_real_photo_pager);
        LogUtil.e("进入了RealPhotoPager");
    ...
    private void getData() {
        realphotourl=getIntent().getStringExtra("realnewsurl");
